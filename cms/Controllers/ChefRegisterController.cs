...
namespace cms.Controllers
{
    ...
    public class ChefRegisterController : BaseController
    {
        ...
        public ActionResult SavePayments(string PeopleId)
        {
            ...
            try
            {
                ...
                ViewBag.RefNo = RefNo;
                insertrecords(NoOfPeople, numberofplates, emailId, fPhoneNo, Occasionvalue, EventsType, CuisineType, RefNo, AddressId, FromTime, ToTime, RequestDate, NamesId);
               // SendEMail(emailId, RefNo, Occasionvalue, EventsType, CuisineType, TotalPriceId);
                SendSMS(fPhoneNo, RefNo, Occasionvalue, EventsType, CuisineType, TotalPriceId, FromTime, ToTime, NamesId);
       ...
       // ubachefEntities db = new ubachefEntities();
        ...
        private void SendEMail(string EmailAddress, string RefNo, string Occasionvalue = "", string EventsType = "", string CuisineType = "", string TotalPriceId = "")
        {
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("ubachefnoreply@gmail.com", "ubachefnoreply27");
            ...
            var Body = "Dear Customer. You have Booked a Chef for " + CuisineType + " " + "Occasion: " + Occasionvalue + " for " + EventsType + " Event. RefNo: " + RefNo + ". Amount to pay " + TotalPriceId;
